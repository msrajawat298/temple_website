 jQuery(document).ready(function($){
    ...
    var aptsesson=$('#aptsesson').val();
	var apthall= $('#apthall').val();
	...
	else if(aptsesson.length==0){$('#erappt').fadeIn(2000);$('#erappt').fadeOut('slow');return false;}
	else if(apthall.length==0){$('#erappt').fadeIn(2000);$('#erappt').fadeOut('slow');return false;}
    ...
    var dataString = 'Name: ' + app + ' Session: ' + aptsesson + ' Hall: '+ apthall ;
